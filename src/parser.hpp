...
switch (yykind)
    {
      ...
      {
        return calcxx_parser::symbol_name (this->kind ());
      }
...
#if 201103L <= YY_CPLUSPLUS
    /// Non copyable.
    calcxx_parser (const calcxx_parser&) = delete;
    /// Non copyable.
    calcxx_parser& operator= (const calcxx_parser&) = delete;
#endif
    ...
    {
    public:
      context (const calcxx_parser& yyparser, const symbol_type& yyla);
  ...
  calcxx_parser::yytranslate_ (int t) YY_NOEXCEPT
  {
  ...
  // basic_symbol.
  template <typename Base>
  calcxx_parser::basic_symbol<Base>::basic_symbol (const basic_symbol& that)
    : Base (that)
    , value ()
  ...
  template <typename Base>
  calcxx_parser::symbol_kind_type
  calcxx_parser::basic_symbol<Base>::type_get () const YY_NOEXCEPT
  {
    return this->kind ();
  }
  ...
  template <typename Base>
  bool
  calcxx_parser::basic_symbol<Base>::empty () const YY_NOEXCEPT
  {
  ...
  // by_kind.
  inline
  calcxx_parser::by_kind::by_kind () YY_NOEXCEPT
    : kind_ (symbol_kind::S_YYEMPTY)
  {}

#if 201103L <= YY_CPLUSPLUS
  inline
  calcxx_parser::by_kind::by_kind (by_kind&& that) YY_NOEXCEPT
    : kind_ (that.kind_)
  {
    that.clear ();
  }
  ...
  inline
  calcxx_parser::by_kind::by_kind (const by_kind& that) YY_NOEXCEPT
    : kind_ (that.kind_)
  {}

  inline
  calcxx_parser::by_kind::by_kind (token_kind_type t) YY_NOEXCEPT
  ...
  inline
  void
  calcxx_parser::by_kind::clear () YY_NOEXCEPT
  {
    kind_ = symbol_kind::S_YYEMPTY;
  }
  ...
  inline
  void
  calcxx_parser::by_kind::move (by_kind& that)
  {
    kind_ = that.kind_;
    that.clear ();
  }
  ...
  inline
  calcxx_parser::symbol_kind_type
  calcxx_parser::by_kind::kind () const YY_NOEXCEPT
  {
    return kind_;
  }
  ...
  inline
  calcxx_parser::symbol_kind_type
  calcxx_parser::by_kind::type_get () const YY_NOEXCEPT
  {
    return this->kind ();
  }
