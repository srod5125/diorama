...
#line 142 "./src/parser.cpp"
  ...
  calcxx_parser::syntax_error::~syntax_error () YY_NOEXCEPT YY_NOTHROW
  {}
  ...
  // by_state.
  calcxx_parser::by_state::by_state () YY_NOEXCEPT
    : state (empty_state)
  {}

  calcxx_parser::by_state::by_state (const by_state& that) YY_NOEXCEPT
    : state (that.state)
  {}

  void
  calcxx_parser::by_state::clear () YY_NOEXCEPT
  {
    state = empty_state;
  }
  ...
  calcxx_parser::by_state::by_state (state_type s) YY_NOEXCEPT
    : state (s)
  {}

  calcxx_parser::symbol_kind_type
  calcxx_parser::by_state::kind () const YY_NOEXCEPT
  {
  ...
  calcxx_parser::stack_symbol_type::stack_symbol_type (YY_RVREF (stack_symbol_type) that)
  ...
  calcxx_parser::stack_symbol_type::stack_symbol_type (state_type s, YY_MOVE_REF (symbol_type) that)
  ...
  calcxx_parser::stack_symbol_type&
  calcxx_parser::stack_symbol_type::operator= (stack_symbol_type& that)
  {
    state = that.state;
    switch (that.kind ())
    {
  ...
  template <typename Base>
  void
  calcxx_parser::yy_print_ (std::ostream& yyo, const basic_symbol<Base>& yysym) const
  {
...
#line 335 "./src/parser.cpp"
        break;

      case symbol_kind::S_exp: // exp
#line 50 "diorama_parser.yy"
                 { yyoutput << yysym.value.template as < int > (); }
#line 341 "./src/parser.cpp"
        break;
  ...
  void
  calcxx_parser::yypush_ (const char* m, YY_MOVE_REF (stack_symbol_type) sym)
  {
    if (m)
  ...
  void
  calcxx_parser::yypush_ (const char* m, state_type s, YY_MOVE_REF (symbol_type) sym)
  {
#if 201103L <= YY_CPLUSPLUS
  ...
  void
  calcxx_parser::yypop_ (int n) YY_NOEXCEPT
  {
    yystack_.pop (n);
  }
  ...
  bool
  calcxx_parser::yy_pact_value_is_default_ (int yyvalue) YY_NOEXCEPT
  {
    return yyvalue == yypact_ninf_;
  }

  bool
  calcxx_parser::yy_table_value_is_error_ (int yyvalue) YY_NOEXCEPT
  {
    return yyvalue == yytable_ninf_;
  }

  int
  calcxx_parser::operator() ()
  {
    return parse ();
  }
...
#line 19 "diorama_parser.yy"
{
  yyla.location.begin.filename = yyla.location.end.filename = &driver.file;
}

#line 465 "./src/parser.cpp"
...
#line 57 "diorama_parser.yy"
                {
                  driver.result = yystack_[0].value.as < int > ();
                }
#line 614 "./src/parser.cpp"
    break;

  case 3: // assignments: %empty
#line 62 "diorama_parser.yy"
                {
                }
#line 621 "./src/parser.cpp"
    break;

  case 4: // assignments: assignments assignment
#line 65 "diorama_parser.yy"
                {
                }
...
#line 636 "./src/parser.cpp"
  ...
  case 6: // exp: exp "+" exp
#line 76 "diorama_parser.yy"
                {
                  yylhs.value.as < int > () = yystack_[2].value.as < int > () + yystack_[0].value.as < int > ();
                }
#line 644 "./src/parser.cpp"
    break;

  case 7: // exp: exp "-" exp
#line 80 "diorama_parser.yy"
                {
                  yylhs.value.as < int > () = yystack_[2].value.as < int > () - yystack_[0].value.as < int > ();
                }
...
#line 660 "./src/parser.cpp"
  ...
  case 9: // exp: exp "/" exp
#line 88 "diorama_parser.yy"
                {
                  yylhs.value.as < int > () = yystack_[2].value.as < int > () / yystack_[0].value.as < int > ();
                }
#line 668 "./src/parser.cpp"
    break;

  case 10: // exp: "(" exp ")"
#line 92 "diorama_parser.yy"
                {
...
#line 696 "./src/parser.cpp"
  ...
  std::string
  calcxx_parser::symbol_name (symbol_kind_type yysymbol)
  {
  ...
  // calcxx_parser::context.
  calcxx_parser::context::context (const calcxx_parser& yyparser, const symbol_type& yyla)
    : yyparser_ (yyparser)
    , yyla_ (yyla)
  {}

  int
  calcxx_parser::context::expected_tokens (symbol_kind_type yyarg[], int yyargn) const
  {
  ...
  int
  calcxx_parser::yy_syntax_error_arguments_ (const context& yyctx,
  ...
  std::string
  calcxx_parser::yysyntax_error_ (const context& yyctx) const
  {
    // Its maximum.
    enum { YYARGS_MAX = 5 };
...
#undef YYCASE_
  ...
  {
       0,    56,    56,    61,    64,    69,    75,    79,    83,    87,
      91,    95,    99
  };

  void
  calcxx_parser::yy_stack_print_ () const
  {
    *yycdebug_ << "Stack now";
  ...
  void
  calcxx_parser::yy_reduce_print_ (int yyrule) const
  {
